...
Los datos se almacenan de manera relacional simple a través de llaves de clave-valor serializadas en JSON:

```json
{
  "usuario_activo": "Sneider",
  "usuarios": {
    "Sneider": "ContraseñaSegura1",
    "Carlos": "ContraseñaNueva2"
  },
  "listas": {
    "Sneider": [
      {
        "titulo": "The Best of Sade",
        "tipo": "musica",
        "estado": "en_progreso",
        "mb": {
          "id": "9c4c34b0-cc6a-3cc5-8591-ed670c2f18bb",
          "title": "The Best of Sade",
          "artist": "Sade",
          "year": "1994",
          "cover": "https://coverartarchive.org/release/9c4c34b0-cc6a-3cc5-8591-ed670c2f18bb/front-250"
        }
      }
    ]
  },
  ...
  "avatar_Sneider": "https://robohash.org/Sneider?set=set4"
}
```
